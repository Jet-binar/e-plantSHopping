...
function ProductList({ onHomeClick }) {
    ...
    // Check if a plant is in cart
    const isInCart = (plantName) => {
        return cartItems.some(item => item.name === plantName && item.quantity > 0);
    };
                        ...
                        <div key={categoryIndex}>
                            ...
                            <div className="product-list">
                                {categoryData.plants.map((plant, plantIndex) => {
                                    const addedToCart = isInCart(plant.name);
                                    const plantWithCategory = { ...plant, category: categoryData.category };
                                    return (
                                        <div className="product-card" key={plantIndex}>
                                            ...
                                            <button
                                                ...
                                                onClick={() => handleAddToCart(plantWithCategory)}
